...
namespace swf_reader::tags
{
	...
	public:
		Box<SwfTagBase> create(SwfTagType tag_type)
		{
			...
			//	return std::make_unique<DefineShapeTag>();
			...
			//	return std::make_unique<DefineShape2Tag>();
			...
			//	return std::make_unique<DefineShape3Tag>();
			...
			//	return std::make_unique<DefineShape4Tag>();
